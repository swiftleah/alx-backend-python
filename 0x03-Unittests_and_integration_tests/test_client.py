...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_org(self, input, mock):
        ''' tests that correct value returned from githuborgclient '''
        test_class = GithubOrgClient(input)
        test_class.org()
        mock.called_with_once(test_class.ORG_URL.format(org=org_name))

    def test_public_repos_url(self):
        ''' tests that correct value is returned on given payload '''
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    ...
    def test_public_repos_with_license(self):
        ''' test for public repo with licenses '''
        test_class = GithubOrgClient("google")
